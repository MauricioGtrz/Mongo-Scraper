...
var MONGODB_URI =
  ...
  "mongodb+srv://Mauricio:Mauricio@cluster0.yqr0r.mongodb.net/<dbname>?retryWrites=true&w=majority";
  ...
  db.Article.findOneAndUpdate(
    ...
    function (err) {
      if (err) {
        ...
        db.Note.deleteMany({ article: req.params.id }).exec(function (err) {
          if (err) {
            console.log(err);
            res.end(err);
          } else res.send("Article Deleted");
        });
      }
    }
  );
